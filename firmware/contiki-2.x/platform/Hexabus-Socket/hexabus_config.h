...
#define METERING_ENERGY_PERSISTENT 1 // Persistently store energy value (number of pulses) in EEPROM. Caution: Needs external circuitry (see the Wiki)! -- CAUTION: Disables relay output!
