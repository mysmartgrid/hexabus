...
#define VALUE_BROADCAST_AUTO_EIDS 2,21 // Comma-separated list of endpoints to broadcast automatically
...
#define S0_ENABLE 1 //S0 meter instead of internal meter.
#define METERING_DEBUG 8
