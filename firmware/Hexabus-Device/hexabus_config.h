...
#elif HAVE(PLUGPLUS)
 #define VALUE_BROADCAST_AUTO_EIDS EP_POWER_SWITCH, EP_POWER_METER, EP_ENERGY_METER
#elif HAVE(EMOS)
...
#elif HAVE(JUNCTION_DIMMER)
 #define VALUE_BROADCAST_AUTO_EIDS \
		EP_POWER_METER, EP_METERING_RMS_CURRENT, EP_METERING_RMS_VOLTAGE, EP_METERING_FREQUENCY, EP_METERING_REACTIVE_POWER, \
		EP_METERING_POWER_FACTOR, EP_METERING_APPARENT_POWER, EP_METERING_FUNDAMENTAL_ACTIVE_POWER, \
		EP_METERING_FUNDAMENTAL_REACTIVE_POWER, EP_DIMMER_MODE, EP_DIMMER_BRIGHTNESS
#endif
