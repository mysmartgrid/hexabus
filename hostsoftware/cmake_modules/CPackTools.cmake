...
function (get_revision_info REV_INFO)
  execute_process (
    COMMAND git rev-list master..HEAD
    COMMAND wc -l
...
set(CPACK_PACKAGE_FILE_NAME "${PROJECT_NAME}_${CPACK_PACKAGE_VERSION}.${PROJECT_REVISION}-1_${CPACK_DEBIAN_PACKAGE_ARCHITECTURE}")
