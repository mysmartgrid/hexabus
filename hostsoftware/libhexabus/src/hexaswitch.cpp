...
struct PacketPrinter : public hexabus::PacketVisitor {
	...
	public:
		...
		virtual void visit(const hexabus::ReportPacket<boost::array<char, HXB_16BYTES_PACKET_BUFFER_LENGTH> >& report) { printReportPacket(report, "Binary (16 bytes)"); }
		virtual void visit(const hexabus::ReportPacket<boost::array<char, HXB_65BYTES_PACKET_BUFFER_LENGTH> >& report) { printReportPacket(report, "Binary (66 bytes)"); }
		...
		virtual void visit(const hexabus::ProxyInfoPacket<boost::array<char, HXB_16BYTES_PACKET_BUFFER_LENGTH> >& proxyInfo) { printProxyInfoPacket(proxyInfo, "Binary (16 bytes)"); }
		virtual void visit(const hexabus::ProxyInfoPacket<boost::array<char, HXB_65BYTES_PACKET_BUFFER_LENGTH> >& proxyInfo) { printProxyInfoPacket(proxyInfo, "Binary (66 bytes)"); }
		...
		virtual void visit(const hexabus::PropertyWritePacket<boost::array<char, HXB_16BYTES_PACKET_BUFFER_LENGTH> >& propwrite) {}
		virtual void visit(const hexabus::PropertyWritePacket<boost::array<char, HXB_65BYTES_PACKET_BUFFER_LENGTH> >& propwrite) {}
		...
		virtual void visit(const hexabus::PropertyReportPacket<boost::array<char, HXB_16BYTES_PACKET_BUFFER_LENGTH> >& propreport) { printPropertyReportPacket(propreport, "Binary (16 bytes)"); }
		virtual void visit(const hexabus::PropertyReportPacket<boost::array<char, HXB_65BYTES_PACKET_BUFFER_LENGTH> >& propreport) { printPropertyReportPacket(propreport, "Binary (65 bytes)"); }
