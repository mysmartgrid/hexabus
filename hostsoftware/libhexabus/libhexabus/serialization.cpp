		...
		case HXB_PTYPE_WRITE:
			{
				...
				switch (datatype) {
					...
					case HXB_DTYPE_16BYTES:
						return checkInfo<boost::array<char, HXB_16BYTES_PACKET_MAX_BUFFER_LENGTH> >(info, eid, read_bytes<HXB_16BYTES_PACKET_MAX_BUFFER_LENGTH>(), flags, sequenceNumber);

					case HXB_DTYPE_66BYTES:
						return checkInfo<boost::array<char, HXB_66BYTES_PACKET_MAX_BUFFER_LENGTH> >(info, eid, read_bytes<HXB_66BYTES_PACKET_MAX_BUFFER_LENGTH>(), flags, sequenceNumber);
					default:
